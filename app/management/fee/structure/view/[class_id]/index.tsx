    ...
    >
      <View className="px-4 py-6 space-y-6">
        <View className="flex-row items-center justify-between">
          <View>
            <Text className="text-2xl font-bold text-gray-900 dark:text-white">Fee Structure Details</Text>
            <Text className="text-sm mt-1 text-gray-600 dark:text-gray-400">{feeStructure?.class_name}</Text>
          </View>
          <TouchableOpacity
        ...
        <View className="rounded-lg p-4 border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800">
          ...
          <Text className="text-lg font-semibold text-gray-900 dark:text-white">{feeStructure?.class_name}</Text>
        </View>
        ...
        <View className="space-y-3">
          <Text className="text-lg font-semibold text-gray-900 dark:text-white">Fee Components Breakdown</Text>
          {feeStructure?.components?.map((component: any, index: number) => (
            ...
            >
              <View className="flex-row items-center justify-between">
                <Text className="font-medium text-gray-900 dark:text-white">{component.head_name}</Text>
