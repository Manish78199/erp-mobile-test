      ...
      <Modal visible={isOpen} transparent animationType="fade" onRequestClose={() => setIsOpen(false)}>
        <View className="flex-1 bg-black/50 justify-center items-center p-4">
          <View className="bg-white dark:bg-gray-800 rounded-lg p-6 w-full max-w-sm">
            <Text className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Add New Syllabus</Text>
            ...
            <View className="mb-6">
              <Text className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Select Syllabus PDF</Text>
              <TouchableOpacity
                onPress={handleFileUpload}
                className="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg p-4 items-center"
              >
            ...
            <View className="flex-row justify-end gap-3">
              ...
              {!isCreating ? (
                ...
                >
                  <Text className="text-gray-900 dark:text-white font-semibold">Add Syllabus</Text>
                </TouchableOpacity>
              ) : (
      ...
      <ScrollView className="flex-1 px-4">
        <View className="mt-6 flex-row justify-end">
          ...
          >
            ...
            <Text className="text-gray-700 dark:text-gray-300 font-medium">Add Syllabus</Text>
          </TouchableOpacity>
        </View>

        <View className="mt-6">
          <Text className="text-2xl font-bold text-gray-900 dark:text-white">Class's Syllabus</Text>
          <Text className="text-gray-600 dark:text-gray-400 mt-1">Manage Class's Syllabus.</Text>
        </View>

        <View className="mt-6 flex-row gap-2">
          <TouchableOpacity className="flex-row items-center gap-2 px-3 py-2 rounded-lg bg-gray-100 dark:bg-gray-800">
            <MaterialIcons name="filter-list" size={18} color={isDark ? "#fff" : "#000"} />
            <Text className="text-gray-700 dark:text-gray-300 text-sm">Filter By</Text>
          </TouchableOpacity>

          <TouchableOpacity className="flex-row items-center gap-2 px-3 py-2 rounded-lg bg-gray-100 dark:bg-gray-800">
            <MaterialCommunityIcons name="file-export" size={18} color={isDark ? "#fff" : "#000"} />
            <Text className="text-gray-700 dark:text-gray-300 text-sm">Exports</Text>
          </TouchableOpacity>
        </View>

        <View className="mt-6 mb-6">
          <Text className="text-lg font-semibold text-gray-900 dark:text-white mb-4">All Syllabus</Text>
          {allSyllabus.length > 0 ? (
            ...
            <View className="items-center justify-center py-8">
              ...
              <Text className="text-gray-500 dark:text-gray-400 mt-2">No syllabuses found</Text>
            </View>
          )}
        </View>
      </ScrollView>
